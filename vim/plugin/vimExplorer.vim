...
let VEConf.filePanelHotkey.openView        = '<cr>'
...
let VEConf_singleFileHotKeys['openInThisTab'] = VEConf.filePanelHotkey.openView
function! VEConf_singleFileActions['openInThisTab'](path)
    if !isdirectory(a:path)
        exec "q"
        exec "q"
        exec "edit " . g:VEPlatform.escape(a:path)
    else
        exec "VE " . g:VEPlatform.escape(a:path)
    endif
endfunction
